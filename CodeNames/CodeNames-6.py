...
xPos = [-210,-126,-42,42,126,210]
yPos = [-210,-126,-42,42,126,210]
numSquares = len(xPos)*len(yPos)
squareDic = {}
for i in range(len(xPos)):
    for j in range(len(yPos)):
        squareName = "square" + str((i*6)+(j+1))
...
# for i in range(1):
#     createBoard(13,12,6,0,0,0,"Hard",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(13,12,6,0,0,0,"Hard",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(12,13,6,0,0,0,"Hard",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(18,17,1,0,0,0,"Hard-Full",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(17,18,1,0,0,0,"Hard-Full",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(13,12,1,4,4,2,"Hard-Rainbow",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(12,13,1,4,4,2,"Hard-Rainbow",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(16):
    createBoard(9,8,3,7,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(16,33):
    createBoard(7,8,3,9,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(33,49):
    createBoard(8,9,3,7,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(49,66):
    createBoard(9,7,3,8,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(66,83):
    createBoard(7,9,3,8,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(83,100):
    createBoard(8,7,3,9,0,0,"Three-Team",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50):
    createBoard(11,10,0,4,0,4,"Sabotage",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
for i in range(50,100):
    createBoard(10,11,0,4,0,4,"Sabotage",i) #RED, BLUE, BLACK, PURPLE, GREEN, ORANGE
